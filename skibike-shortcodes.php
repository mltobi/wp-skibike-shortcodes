...
//  $retStr = $retStr .  '  <input type="submit" name="nameSubmit" value="Fahrt ausw&auml;hlen"/>';
  $retStr = $retStr .  '</form>';
...
//    $retStr = $retStr . '<pre>' . print_r($orders, true) . '</pre>';
    ...
    foreach( $orders as $order ) {
      ...
      $now_timestamp = $now->getTimestamp();
		   ...
		   // $retStr = $retStr . '<pre>' . print_r($date_created_timestamp, true) . '</pre>';
		   // $retStr = $retStr . '<pre>' . print_r($now_timestamp - $five_months, true) . '</pre>';
